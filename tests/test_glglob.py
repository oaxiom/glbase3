...
class Test_glglob(unittest.TestCase):
    ...
    def test_chip_seq_cluster_heatmap_error(self):
        ...
        self.assertRaises(AssertionError, self.g.chip_seq_cluster_heatmap, [self.data1, self.data2, self.data3], []) # Fails at a differnet stage, but passes the assertion
        self.assertRaises(AssertionError, self.g.chip_seq_cluster_heatmap, [self.data1, self.data2, no_loc_gl], [])
        self.assertRaises(AssertionError, self.g.chip_seq_cluster_heatmap, [self.data1, no_loc_gl, no_loc_gl], [])
