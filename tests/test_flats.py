...
class Test_Flat_Function(unittest.TestCase):
    ...
    def test_pileup_no_respect_strand(self):
        ...
        L, _ = t.pileup(scaled=False, genelists=g, filename="test_images/test_output_no_strand.png", bandwidth=15, respect_strand=False)
    ...
    def test_pileup_respect_strand(self):
        ...
        g = glbase3.genelist(filename="test_data/track_test.bed", format=glbase3.format.bed).pointify().expand('loc', 15)
        L, _ = t.pileup(scaled=False, genelists=g, filename="test_images/test_output_respect_strand.png", bandwidth=15, respect_strand=True)
